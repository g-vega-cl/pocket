...
export function ImproverView({ sessionId, draft, onApply, onBack }: ImproverViewProps) {
  ...
  return (
    <div className="max-w-5xl mx-auto h-[calc(100dvh-2.5rem)] flex flex-col">
      ...
      {/* Input */}
      <div className="px-3 py-2 flex flex-row items-center gap-2 flex-shrink-0">
        <textarea
          ref={inputRef as any}
          value={input}
        ...
        <button
          ...
          className="shrink-0 px-2 py-1.5 bg-purple-500 hover:bg-purple-600 disabled:opacity-50 disabled:cursor-not-allowed text-white text-xs font-medium rounded-lg transition-colors"
        >
          Send
        </button>
      </div>
      ...
      {/* Actions */}
      <div className="px-3 py-2 border-t border-gray-200 dark:border-gray-700 flex flex-row items-center gap-2 flex-shrink-0">
        <button
          onClick={onBack}
        ...
        <button
          ...
          className="ml-auto px-3 py-2 bg-[#4FB8B2] hover:bg-[#3da39d] disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-medium rounded-lg transition-colors"
        >
